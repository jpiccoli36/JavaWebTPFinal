...
@WebServlet("/ServletsRecuperarTipoElementoModificacion")
public class ServletsRecuperarTipoElementoModificacion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public ServletsRecuperarTipoElementoModificacion() {
        super();
