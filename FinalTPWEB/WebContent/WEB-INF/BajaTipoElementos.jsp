...
<body>
<form class="form-signin" name="signin" action="ServletsBajaTipoElementos"
			method="post">
 ...
 <%
			...
			<button class="btn btn-lg btn-primary btn-block"   type="submit" >Baja Tipo Elemento </button>
